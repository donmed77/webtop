...
const page = () => {
  return (
    <div className={styles.container + ' xl:!mt-24 !mt-16'}>
...
<li>
<p><strong>Company</strong> (referred to as either "the Company," "We," "Us," or "Our" in this Agreement) refers to KAZANE LTD, registered in England and Wales under company number 15052512, with its registered address at 71-75 Shelton Street, Covent Garden, London, WC2H 9JQ.</p>
</li>
<li>
...
<li>
<p><strong>Subscription</strong> refer to the services or access to the Service offered on a subscription basis by the Company to You.</p>
 </li>
<li>
...
<li>
<p><strong>Website</strong> refers to UnshortLink, accessible from <a href="https://unshortlink.com" rel="external nofollow noopener" target="_blank">https://unshortlink.com</a></p>
</li>
<li>
...
<h2>Subscriptions</h2>
    ...
    <p>The Service or some parts of the Service are available only with a paid Subscription. You will be billed in advance or retrospectively on a recurring and periodic basis (such as daily, weekly, monthly or annually), depending on the type of Subscription plan you select when purchasing the Subscription.</p>
    <p>Monthly overage charges will be applied in addition to the recurring monthly fee if You exceed the quota limits of a Subscription plan that allows overages.</p>
    ...
    <p>You may cancel Your Subscription renewal through Your Subscriptions dashboard provided by a Third-party Service, or by contacting the Company. You will not receive a refund for the fees You already paid for Your current Subscription period and You will be able to access the Service until the end of Your current Subscription period.</p>
    ...
    <h3>Refunds</h3>
    <p>If you're unhappy with your purchase for any reason, send an email to contact@unshortlink.com within 14 days</p>
    ...
    <p>You agree not to access the Service's backend directly without using the Service's user interface, which includes the Website or frontend.</p>
    ...
    <h2>Publicity</h2>
    <p>By using Our Service, You grant the Company, Service and Website the right to display Your company's logo, trade marks and trade names to identify You as a user/customer of Our Service on Our Website, in addition to any other marketing material for the purpose of showcasing Our clients or promoting Our Service.</p>
    <p>If You prefer not to have Your company's logo, trade marks and trade names used for these purposes, You may opt out at any time by sending a request to contact@unshortlink.com. Upon receiving Your request, we will remove Your company's logo, trade marks and trade names from all applicable materials within a reasonable timeframe.</p>
<h2>Termination</h2>
...
<ul>
<li>By email: contact@unshortlink.com</li>
</ul>
    </div>
  )
}
